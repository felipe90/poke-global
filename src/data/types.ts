...
import elementBug from '@/assets/types/elements/element-bug.svg'
import elementDark from '@/assets/types/elements/element-dark.svg'
import elementDragon from '@/assets/types/elements/element-dragon.svg'
import elementElectric from '@/assets/types/elements/element-electric.svg'
import elementFairy from '@/assets/types/elements/element-fairy.svg'
import elementFighting from '@/assets/types/elements/element-fighting.svg'
import elementFire from '@/assets/types/elements/element-fire.svg'
import elementFlying from '@/assets/types/elements/element-flying.svg'
import elementGhost from '@/assets/types/elements/element-ghost.svg'
import elementGrass from '@/assets/types/elements/element-grass.svg'
import elementGround from '@/assets/types/elements/element-ground.svg'
import elementIce from '@/assets/types/elements/element-ice.svg'
import elementNormal from '@/assets/types/elements/element-normal.svg'
import elementPoison from '@/assets/types/elements/element-poison.svg'
import elementPsychic from '@/assets/types/elements/element-psychic.svg'
import elementRock from '@/assets/types/elements/element-rock.svg'
import elementSteel from '@/assets/types/elements/element-steel.svg'
import elementWater from '@/assets/types/elements/element-water.svg'
